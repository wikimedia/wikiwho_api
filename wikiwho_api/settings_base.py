...
EXTRA_LANG_INFO = {
    ...
    'sh': {
        ...
        'code': 'sh',
        'name': 'Serbo-Croatian',
        'name_local': 'srpsko-hrvatski',
    },
    'simple': {
        'bidi': False,
        'code': 'simple',
        'name': 'Simple English',
        'name_local': 'Simple English',
    },
    'tl': {
        'bidi': False,
        'code': 'tl',
...
WP_RATE_LIMIT_MAX_SLEEP = 60  # fallback sleep when Retry-After is missing [seconds]
WP_RATE_LIMIT_RETRY_BUDGET = 300  # [seconds]
